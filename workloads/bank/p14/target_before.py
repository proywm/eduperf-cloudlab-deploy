...
# Stdlib-only standalone version. The removed block was a dead-code
# calculation of `raid_disks` (number of disks used by PVs on RAID),
# computed but never used in the returned value.
